...
public class ClientChat1 {
    ...
    public static void main(String[] args) {
         ...
         try {
            ...
            //Client will continue to Request the Server even the client will enter close or exit 
            while(true){
                
                System.out.println("You are ready to communicate");
                String Input=SC.nextLine();
                
                Request=Input.getBytes();//convert to bytesarray

                
                //Client Packet that is the packet will send to Server(Request)
            ...
            Logger.getLogger(ClientChat1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
